...
import BottomNav from '../components/Items/BottomNav.vue'
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry"
          ...
          <div class="row gy-4 portfolio-container">
            ...
            <div v-for="(asset, index) in dataAsset " :key="index" class="col-xl-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  <h4><a href="portfolio-details.html" title="More Details">{{ asset.name }}</a></h4>
                  <p>{{ asset.price }}</p>
                </div>
              </div>
